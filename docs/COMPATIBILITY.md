...
| Physical-device confidence | One-device Wi-Fi screens, a ten-run batch and a complete-capture 128 MiB SO_RCVBUF=65536 pair establish integrity and strong scoped sender-visible receive-window control; efficacy and general compatibility are not established |
